      ...
      {currentScene === 'reveal' && progress >= 98 && (
        ...
        >
          <div className="text-center">
            ...
            {/* CTA buttons - Glassmorphism with micro-interactions */}
            <motion.div
              ...
              transition={{ delay: 1 }}
            >
              {/* Contact - Opens email directly */}
              <button
                onClick={() => {
                  window.location.href = "mailto:sonalisharma.tech123@gmail.com";
                }}
              ...
              {/* View Projects - Client-side navigation */}
              <Link href="/projects" className="btn-glass btn-glass-magenta group">
              ...
              {/* Home - Client-side navigation */}
              <Link href="/" className="btn-glass-ghost group">
